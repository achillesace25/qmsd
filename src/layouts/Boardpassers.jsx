...
import '../styles/Boardpassers.css'; // Adjust the path according to your file structure
  ...
  if (csvData.length > 0) {
    ...
    try {
      ...
      if (filteredCsvData.length > 0) {
        ...
        // Save each chunk of data as a separate document in the 'databasebaseboard' collection
        for (let i = 0; i < chunks.length; i++) {
          await addDoc(collection(db, 'databaseboard'), {
